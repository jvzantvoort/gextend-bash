...
do_fmt()          { print_title "format the sources"; action_fmt; }
do_tags()         { print_title "generate tags"; action_tags; }
do_cleanup()      { print_title "cleanup"; action_cleanup; }
do_dependencies() { print_title "update dependencies"; action_dependencies; }
do_install()      { print_title "install locally"; action_install "$(go env GOOS)" "$(go env GOARCH)"; }
do_package()      { print_title "create packages"; action_createpackages; }
do_check()        { print_title "check the sources"; action_check; }
do_list()         { action_list; }
